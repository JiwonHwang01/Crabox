<?php
session_start();
require_once __DIR__ . '../fbSDKsrc/Facebook/autoload.php'; // download official fb sdk for php @ https://github.com/facebook/php-graph-sdk
$fb = new Facebook\Facebook([
'app_id' => '3597626313605829', //님의 앱ID 적어주세요

'app_secret' => '5f4602421356ca4022ffe3e962957a27', //님의 시크릿코드 적어주세요
...
if (isset($accessToken)) { 
    if (isset($_SESSION['facebook_access_token'])) { 
        ...
        try { $profile_request = $fb->get('/me?fields=name,first_name,last_name,email'); 
...
// replace your website URL same as added in the developers.facebook.com/apps e.g. if you used http instead of https and you used non-www version or www version of your website then you must add the same here
        ...
        $loginUrl = $helper->getLoginUrl('https://crabox.io/fbcallback.php', $permissions);
